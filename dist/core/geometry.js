 ...
 */
export function segmentPath(cx, cy, innerRadius, outerRadius, startAngle, endAngle) {
 ...
 */
export function facetScorePath(cx, cy, innerRadius, outerRadius, startAngle, endAngle) {
 ...
 */
export function facetAngles(segmentStartAngle, segmentEndAngle, facetCount) {
    if (facetCount <= 0) {
 ...
 */
export function scoreToRadius(score, minScore, maxScore, innerRadius, outerRadius) {
 ...
 */
export function ringRadii(ringCount, innerRadius, outerRadius) {
    if (ringCount <= 0) {
 ...
 */
export function labelOrientation(angle) {
